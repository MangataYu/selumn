    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: tagsAsync.when(
          ...
          data: (tags) {
            if (tags.isEmpty) {
              return Center(child: Text(context.l10n.diary.tagSortEmpty));
            }
            return Column(
              children: [
                Padding(
                    ...
                    builder: (context, order, _) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          void manage() => showTagActions(context, path);
                          return ListTile(
                            key: ValueKey('tag-manager-row:$path'),
                            minTileHeight: 48,
                            minVerticalPadding: 0,
                            contentPadding: .only(
                              left: spacing.lg + depth.clamp(0, 4) * spacing.md,
                              right: spacing.sm,
                            ),
                            leading: Icon(
                              LucideIcons.hash,
                            ...
                            title: Text(
                              query.isEmpty ? path.split('/').last : path,
                              maxLines: 1,
                              overflow: .ellipsis,
                              style: tagTextStyle,
                            ),
